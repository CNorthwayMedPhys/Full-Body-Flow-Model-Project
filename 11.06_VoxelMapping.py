...
path = dir_path + "\\CN_XCAT_AP_Correct.egsvoi"
...
for vesselNum in range(28,125+1):
    ...
    transition_map = [(-1.68*10)+11 -0.5, (-0.23*10) - 9 -1.7, (-3.5*10)-1]#[(1.6*10)-8.0, (-1.1*10)+5.7, (51.5*10) - 553.7]
...
# plt.figure()         
# plt.imshow(truth[:,:,250], cmap='hot') 
# plt.figure() 
# plt.imshow(truth[:,26,:], cmap='hot')    
...
#%%Write to an excel document
    np.save(dir_path + '\\VOIMappingArrays\\AP\\' + str(vesselNum) + '.npy', dist_voxel_match)
