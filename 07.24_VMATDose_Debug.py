...
BV_num = 1E0 #total number BV
Tss =  1 #round(400*T,3) #Time to reach Steady State (s) #Needs to be a round number!!!
...
class Network (object):
    ...
    def timestep(self):
        ...
        self._localtime = np.round(self._localtime, decimals = 3)
...
dsts = np.arange(0.025,1.025,0.025)
...
for dst in dsts:
    ...
    results[j,2] = dst
    j += 1
    np.save(os.path.join(cd,"dstResults_VMAT.npy"),results)
