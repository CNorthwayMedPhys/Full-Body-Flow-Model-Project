# -*- coding: utf-8 -*-
"""
Load in data for Sweeping Co-60 all sweeps are individual 4D dose files 
Time resolution for dose sampling all processed for 0.1s 

Iterate through BV#'s to determine at what quantity og BV's the STD appears to stabalize

Running a single AP and PA field

In  between fields all BV shuffle positions with each other and then run for 30*T
