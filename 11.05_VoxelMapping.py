...
for vesselNum in range(28,125+1):
    ...
    transition_map = 0 # [(-1.68*10)+11, (-0.23*10) - 9, (-3.5*10) + 1]#[(1.6*10)-8.0, (-1.1*10)+5.7, (51.5*10) - 553.7]
...
Summed = egsphantObj.materialArray + VOIArray  
index = np.where(VOIArray == 10 )
plt.figure()         
plt.imshow(Summed[65,:,:], cmap='hot')   
plt.figure()         
