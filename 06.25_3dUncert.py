...
#%%
location = [37.5,-35.3,109.5]
uncertArray = dose.errorArray
x = np.searchsorted(dose.edges[0],location[0])
y = np.searchsorted(dose.edges[1],location[1])
z = np.searchsorted(dose.edges[2],location[2])

print(uncertArray[x,y,z])
print(np.min(uncertArray))
