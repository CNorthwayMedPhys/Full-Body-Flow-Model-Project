...
class BloodVolume (object):
    ...
    def dose_vesPA(self):
        ...
        Dose to the BV while in vessels
        """
        return self._dose_vesPA
    
    @dose_vesPA.setter 
    def dose_vesPA(self,value):
        self._dose_vesPA = value        
        
    @property 
    def vesselTimePA(self):
        """
        Time the vessels spend accumulating dose in the vessels 
        """
        return self._vesselTimePA
    
    @vesselTimePA.setter 
    def vesselTimePA(self,value):
        self._vesselTimePA = value
...
class Network (object):
    ...
    ###LOAD IN ALL THE TREATMENT TIMES        
...
#%% Excute Simulation
dsts = np.arange(0.002,1.0002,0.002) #Dose sample time step size (s)
dsts = dsts[::-1]
