...
cd = os.getcwd()
filename = "MCDAO_pt9_plan02_w1"

headerfile = os.path.join(cd,filename + '.edepheader')
datafile = os.path.join(cd,filename + '.edepdat')
ainflufile = os.path.join(cd,filename + '.ainflu')
