...
Tss =  1#round(400*T,3) #Time to reach Steady State (s) #Needs to be a round nubmer!!!
Tfield = round(6.81 * 60, 3) #Time per field (s)

#Dose file locations 
cd = os.getcwd()
dose_filename_AP = "XCAT_AP_15E9_relbin.npy"
