...
import numpy as np
from BVTracking_OpOrgan import BVsim
...
def findOptDT():
    ...
    intial_guess = (1.791, 1.74, 0.84, 1.90, 1.99,  1.67,
     1.93, 1.98)
    #Run optimization
    results = optimize.least_squares(ModelError, intial_guess, diff_step = 0.5 , bounds = (0.5,2) )
