...
#%% Excute Simulation
dsts = [0.5,0.4,0.3,0.2,0.1,0.002] #Dose sample time step size (s)
...
for dst in dsts:
    ...
    def runSimulation(dummy_input):
        ...
        for BV in BVolumes:
            ...
            tot_dose = dose_compartment + (dose_vessel * time)
            BV_data[i,0] = tot_dose
    ...
    plt.title('Single AP Fields ' + str(dst))
    plt.legend()
