...
T = 1 #s
tc = 1 #Normally 4 #s
dt = .9e-5 #normally 1e-5 #s
dx = 0.02 #normally 0.1 cm  (unitless)

q_in = inlet(qc, rc, 'AorticFlow_inlet_artifical.csv')
