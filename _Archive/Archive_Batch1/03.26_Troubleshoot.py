...
def lrrTest(lrr_value):
    ...
    vessel_df.at[1,'Radius Values'] = [0.177, 0.11]
    vessel_df.at[2,'Radius Values'] = [0.177, 0.11]
    ...
    out_bc = 'ST'
    p0 =((100 * 1333.22365) * rc**4/(rho*qc**2)) # zero transmural pressure
    ...
    file_name = 'VamPy_ST_dedim_lrr='+str(lrr)
    try:
